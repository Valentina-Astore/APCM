...
public class Client {
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            p.command("bash", "-c","gnome-terminal -- ./AES_CFB_E Client");

            Process process = p.start();
        }catch(IOException e){System.out.println("Error in opening ./AES_CFB_E Client");}
    
    
        try{
            ProcessBuilder p = new ProcessBuilder();

            p.command("bash", "-c","gnome-terminal -- ./AES_CFB_D Client");

            Process process = p.start();
        }catch(IOException e){System.out.println("Error in opening ./AES_CFB_D Client");}
